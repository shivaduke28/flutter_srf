...
import 'srf_containers_provider.dart';

part 'artists_provider.g.dart';

@riverpod
Future<Map<String, List<SrfContainer>>> artists(Ref ref) async {
  final containers = await ref.watch(srfContainersProvider.future);

  final artistMap = <String, List<SrfContainer>>{};
...
class ArtistInfo {
  ...
  final List<SrfContainer> tracks;
