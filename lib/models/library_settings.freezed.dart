...
mixin _$LibrarySettings {
 ...
 String get libraryPath; List<String> get watchedDirectories; bool get autoImport; List<String> get supportedExtensions; DateTime? get lastScanDate;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LibrarySettings&&(identical(other.libraryPath, libraryPath) || other.libraryPath == libraryPath)&&const DeepCollectionEquality().equals(other.watchedDirectories, watchedDirectories)&&(identical(other.autoImport, autoImport) || other.autoImport == autoImport)&&const DeepCollectionEquality().equals(other.supportedExtensions, supportedExtensions)&&(identical(other.lastScanDate, lastScanDate) || other.lastScanDate == lastScanDate));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,libraryPath,const DeepCollectionEquality().hash(watchedDirectories),autoImport,const DeepCollectionEquality().hash(supportedExtensions),lastScanDate);
...
@useResult
$Res call({
 String libraryPath, List<String> watchedDirectories, bool autoImport, List<String> supportedExtensions, DateTime? lastScanDate
});
...
/// Create a copy of LibrarySettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? libraryPath = null,Object? watchedDirectories = null,Object? autoImport = null,Object? supportedExtensions = null,Object? lastScanDate = freezed,}) {
  return _then(_self.copyWith(
libraryPath: null == libraryPath ? _self.libraryPath : libraryPath // ignore: cast_nullable_to_non_nullable
as String,watchedDirectories: null == watchedDirectories ? _self.watchedDirectories : watchedDirectories // ignore: cast_nullable_to_non_nullable
as List<String>,autoImport: null == autoImport ? _self.autoImport : autoImport // ignore: cast_nullable_to_non_nullable
...
as List<String>,lastScanDate: freezed == lastScanDate ? _self.lastScanDate : lastScanDate // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
...
class _LibrarySettings implements LibrarySettings {
  const _LibrarySettings({required this.libraryPath, required final  List<String> watchedDirectories, required this.autoImport, required final  List<String> supportedExtensions, this.lastScanDate}): _watchedDirectories = watchedDirectories,_supportedExtensions = supportedExtensions;
...
@override List<String> get watchedDirectories {
  if (_watchedDirectories is EqualUnmodifiableListView) return _watchedDirectories;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LibrarySettings&&(identical(other.libraryPath, libraryPath) || other.libraryPath == libraryPath)&&const DeepCollectionEquality().equals(other._watchedDirectories, _watchedDirectories)&&(identical(other.autoImport, autoImport) || other.autoImport == autoImport)&&const DeepCollectionEquality().equals(other._supportedExtensions, _supportedExtensions)&&(identical(other.lastScanDate, lastScanDate) || other.lastScanDate == lastScanDate));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,libraryPath,const DeepCollectionEquality().hash(_watchedDirectories),autoImport,const DeepCollectionEquality().hash(_supportedExtensions),lastScanDate);
...
/// Create a copy of LibrarySettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? libraryPath = null,Object? watchedDirectories = null,Object? autoImport = null,Object? supportedExtensions = null,Object? lastScanDate = freezed,}) {
  return _then(_LibrarySettings(
libraryPath: null == libraryPath ? _self.libraryPath : libraryPath // ignore: cast_nullable_to_non_nullable
as String,watchedDirectories: null == watchedDirectories ? _self._watchedDirectories : watchedDirectories // ignore: cast_nullable_to_non_nullable
as List<String>,autoImport: null == autoImport ? _self.autoImport : autoImport // ignore: cast_nullable_to_non_nullable
