...
mixin _$AlbumsState {
 ...
 List<Album> get allAlbums; String get searchQuery; AlbumSortType get sortType;
...
@useResult
$Res call({
 List<Album> allAlbums, String searchQuery, AlbumSortType sortType
});
...
as List<Album>,searchQuery: null == searchQuery ? _self.searchQuery : searchQuery // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Album> allAlbums,  String searchQuery,  AlbumSortType sortType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AlbumsState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Album> allAlbums,  String searchQuery,  AlbumSortType sortType)  $default,) {final _that = this;
switch (_that) {
case _AlbumsState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Album> allAlbums,  String searchQuery,  AlbumSortType sortType)?  $default,) {final _that = this;
switch (_that) {
case _AlbumsState() when $default != null:
return $default(_that.allAlbums,_that.searchQuery,_that.sortType);case _:
  return null;
...
class _AlbumsState implements AlbumsState {
  const _AlbumsState({required final  List<Album> allAlbums, required this.searchQuery, required this.sortType}): _allAlbums = allAlbums;
  

 final  List<Album> _allAlbums;
@override List<Album> get allAlbums {
