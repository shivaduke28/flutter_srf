...
mixin _$AlbumQueryState {
  ...
  $AlbumQueryStateCopyWith<AlbumQueryState> get copyWith =>
      _$AlbumQueryStateCopyWithImpl<AlbumQueryState>(
          this as AlbumQueryState, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is AlbumQueryState &&
...
abstract mixin class $AlbumQueryStateCopyWith<$Res> {
  factory $AlbumQueryStateCopyWith(AlbumQueryState value,
      $Res Function(AlbumQueryState) _then) = _$AlbumQueryStateCopyWithImpl;
...
extension AlbumQueryStatePatterns on AlbumQueryState {
  ...
  TResult Function( _AlbumQueryState value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _AlbumQueryState implements AlbumQueryState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AlbumQueryStateCopyWith<_AlbumQueryState> get copyWith =>
      __$AlbumQueryStateCopyWithImpl<_AlbumQueryState>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _AlbumQueryState &&
            (identical(other.searchQuery, searchQuery) ||
                other.searchQuery == searchQuery) &&
            (identical(other.sortType, sortType) ||
                other.sortType == sortType));
...
/// @nodoc
abstract mixin class _$AlbumQueryStateCopyWith<$Res>
    implements $AlbumQueryStateCopyWith<$Res> {
  factory _$AlbumQueryStateCopyWith(_AlbumQueryState value,
      $Res Function(_AlbumQueryState) _then) = __$AlbumQueryStateCopyWithImpl;
