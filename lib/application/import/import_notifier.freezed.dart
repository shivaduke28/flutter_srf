...
mixin _$ImportState {
  ...
  $ImportStateCopyWith<ImportState> get copyWith =>
      _$ImportStateCopyWithImpl<ImportState>(this as ImportState, _$identity);
  ...
  int get hashCode =>
      Object.hash(
      runtimeType, totalFiles, processedFiles, currentFile, isImporting,
...
abstract mixin class $ImportStateCopyWith<$Res> {
  factory $ImportStateCopyWith(ImportState value,
      $Res Function(ImportState) _then) = _$ImportStateCopyWithImpl;

  @useResult
  $Res call({
    int totalFiles, int processedFiles, String currentFile, bool isImporting, List<
        String> errors
  });
...
class _$ImportStateCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? totalFiles = null, Object? processedFiles = null, Object? currentFile = null, Object? isImporting = null, Object? errors = null,}) {
...
extension ImportStatePatterns on ImportState {
  ...
  TResult Function( _ImportState value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _ImportState implements ImportState {
  const _ImportState(
      {required this.totalFiles, required this.processedFiles, required this.currentFile, required this.isImporting, final List<
          String> errors = const []}) : _errors = errors;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ImportStateCopyWith<_ImportState> get copyWith =>
      __$ImportStateCopyWithImpl<_ImportState>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _ImportState &&
            (identical(other.totalFiles, totalFiles) ||
                other.totalFiles == totalFiles) &&
            (identical(other.processedFiles, processedFiles) ||
                other.processedFiles == processedFiles) &&
...
/// @nodoc
abstract mixin class _$ImportStateCopyWith<$Res>
    implements $ImportStateCopyWith<$Res> {
  factory _$ImportStateCopyWith(_ImportState value,
      $Res Function(_ImportState) _then) = __$ImportStateCopyWithImpl;
