...
mixin _$ArtistQueryState {
  ...
  ArtistSortType get sortType;

  /// Create a copy of ArtistQueryState
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ArtistQueryStateCopyWith<ArtistQueryState> get copyWith =>
      _$ArtistQueryStateCopyWithImpl<ArtistQueryState>(
          this as ArtistQueryState, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ArtistQueryState &&
...
abstract mixin class $ArtistQueryStateCopyWith<$Res> {
  factory $ArtistQueryStateCopyWith(ArtistQueryState value,
      $Res Function(ArtistQueryState) _then) = _$ArtistQueryStateCopyWithImpl;
...
class _$ArtistQueryStateCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? searchQuery = null, Object? sortType = null,}) {
...
extension ArtistQueryStatePatterns on ArtistQueryState {
  ...
  TResult Function( _ArtistQueryState value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _ArtistQueryState implements ArtistQueryState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ArtistQueryStateCopyWith<_ArtistQueryState> get copyWith =>
      __$ArtistQueryStateCopyWithImpl<_ArtistQueryState>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _ArtistQueryState &&
            (identical(other.searchQuery, searchQuery) ||
                other.searchQuery == searchQuery) &&
            (identical(other.sortType, sortType) ||
                other.sortType == sortType));
...
/// @nodoc
abstract mixin class _$ArtistQueryStateCopyWith<$Res>
    implements $ArtistQueryStateCopyWith<$Res> {
  factory _$ArtistQueryStateCopyWith(_ArtistQueryState value,
      $Res Function(_ArtistQueryState) _then) = __$ArtistQueryStateCopyWithImpl;
