...
sealed class ArtistQueryState with _$ArtistQueryState {
  const factory ArtistQueryState({required String searchQuery, required ArtistSortType sortType}) = _ArtistQueryState;
}
...
class ArtistQueryController extends _$ArtistQueryController {
  ...
  ArtistQueryState build() {
    return const ArtistQueryState(searchQuery: '', sortType: ArtistSortType.name);
  }
