...
mixin _$Artist {
 ...
 String get id; String get name; List<String> get albumIds; List<String> get trackIds;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Artist&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.albumIds, albumIds)&&const DeepCollectionEquality().equals(other.trackIds, trackIds));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,const DeepCollectionEquality().hash(albumIds),const DeepCollectionEquality().hash(trackIds));
...
/// Create a copy of Artist
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? albumIds = null,Object? trackIds = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,albumIds: null == albumIds ? _self.albumIds : albumIds // ignore: cast_nullable_to_non_nullable
as List<String>,trackIds: null == trackIds ? _self.trackIds : trackIds // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
...
class _Artist implements Artist {
  const _Artist({required this.id, required this.name, required final  List<String> albumIds, required final  List<String> trackIds}): _albumIds = albumIds,_trackIds = trackIds;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Artist&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._albumIds, _albumIds)&&const DeepCollectionEquality().equals(other._trackIds, _trackIds));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,const DeepCollectionEquality().hash(_albumIds),const DeepCollectionEquality().hash(_trackIds));
...
/// Create a copy of Artist
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? albumIds = null,Object? trackIds = null,}) {
  return _then(_Artist(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,albumIds: null == albumIds ? _self._albumIds : albumIds // ignore: cast_nullable_to_non_nullable
as List<String>,trackIds: null == trackIds ? _self._trackIds : trackIds // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
