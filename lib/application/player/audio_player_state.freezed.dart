...
mixin _$AudioPlayerState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is AudioPlayerState &&
  ...
  int get hashCode =>
      Object.hash(
      runtimeType, currentContainer, status, position, duration, volume);
...
abstract mixin class $AudioPlayerStateCopyWith<$Res> {
  factory $AudioPlayerStateCopyWith(AudioPlayerState value,
      $Res Function(AudioPlayerState) _then) = _$AudioPlayerStateCopyWithImpl;
...
class _$AudioPlayerStateCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? currentContainer = freezed, Object? status = null, Object? position = null, Object? duration = null, Object? volume = null,}) {
...
extension AudioPlayerStatePatterns on AudioPlayerState {
  ...
  TResult Function( _AudioPlayerState value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _AudioPlayerState implements AudioPlayerState {
  const _AudioPlayerState({this.currentContainer, this.status = PlayerStatus
      .stopped, this.position = Duration.zero, this.duration = Duration
      .zero, this.volume = 1.0});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _AudioPlayerState &&
            (identical(other.currentContainer, currentContainer) ||
                other.currentContainer == currentContainer) &&
            (identical(other.status, status) || other.status == status) &&
            (identical(other.position, position) ||
...
abstract mixin class _$AudioPlayerStateCopyWith<$Res>
    implements $AudioPlayerStateCopyWith<$Res> {
  factory _$AudioPlayerStateCopyWith(_AudioPlayerState value,
      $Res Function(_AudioPlayerState) _then) = __$AudioPlayerStateCopyWithImpl;
