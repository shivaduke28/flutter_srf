...
mixin _$TrackQueryState {
  ...
  TrackSortType get sortType;

  /// Create a copy of TrackQueryState
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $TrackQueryStateCopyWith<TrackQueryState> get copyWith =>
      _$TrackQueryStateCopyWithImpl<TrackQueryState>(
          this as TrackQueryState, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is TrackQueryState &&
...
abstract mixin class $TrackQueryStateCopyWith<$Res> {
  factory $TrackQueryStateCopyWith(TrackQueryState value,
      $Res Function(TrackQueryState) _then) = _$TrackQueryStateCopyWithImpl;
...
extension TrackQueryStatePatterns on TrackQueryState {
  ...
  TResult Function( _TrackQueryState value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _TrackQueryState implements TrackQueryState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TrackQueryStateCopyWith<_TrackQueryState> get copyWith =>
      __$TrackQueryStateCopyWithImpl<_TrackQueryState>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _TrackQueryState &&
            (identical(other.searchQuery, searchQuery) ||
                other.searchQuery == searchQuery) &&
            (identical(other.sortType, sortType) ||
                other.sortType == sortType));
...
/// @nodoc
abstract mixin class _$TrackQueryStateCopyWith<$Res>
    implements $TrackQueryStateCopyWith<$Res> {
  factory _$TrackQueryStateCopyWith(_TrackQueryState value,
      $Res Function(_TrackQueryState) _then) = __$TrackQueryStateCopyWithImpl;
