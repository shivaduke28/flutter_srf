...
mixin _$TracksState {
  ...
  $TracksStateCopyWith<TracksState> get copyWith =>
      _$TracksStateCopyWithImpl<TracksState>(this as TracksState, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is TracksState &&
            const DeepCollectionEquality().equals(other.allTracks, allTracks));
  }


  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(allTracks));
...
abstract mixin class $TracksStateCopyWith<$Res> {
  factory $TracksStateCopyWith(TracksState value,
      $Res Function(TracksState) _then) = _$TracksStateCopyWithImpl;
...
class _$TracksStateCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? allTracks = null,}) {
    return _then(_self.copyWith(
      allTracks: null == allTracks
          ? _self.allTracks
          : allTracks // ignore: cast_nullable_to_non_nullable
      as List<Track>,
    ));
  }
...
extension TracksStatePatterns on TracksState {
  ...
  TResult Function( _TracksState value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _TracksState implements TracksState {
  const _TracksState({required final List<Track> allTracks})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TracksStateCopyWith<_TracksState> get copyWith =>
      __$TracksStateCopyWithImpl<_TracksState>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _TracksState &&
            const DeepCollectionEquality().equals(
                other._allTracks, _allTracks));
  }


  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(_allTracks));
...
/// @nodoc
abstract mixin class _$TracksStateCopyWith<$Res>
    implements $TracksStateCopyWith<$Res> {
  factory _$TracksStateCopyWith(_TracksState value,
      $Res Function(_TracksState) _then) = __$TracksStateCopyWithImpl;
