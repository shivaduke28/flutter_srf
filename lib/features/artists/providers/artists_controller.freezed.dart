...
mixin _$ArtistsState {
 ...
 List<ArtistInfo> get allArtists; String get searchQuery; ArtistSortType get sortType;
...
@useResult
$Res call({
 List<ArtistInfo> allArtists, String searchQuery, ArtistSortType sortType
});
...
as List<ArtistInfo>,searchQuery: null == searchQuery ? _self.searchQuery : searchQuery // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<ArtistInfo> allArtists,  String searchQuery,  ArtistSortType sortType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ArtistsState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<ArtistInfo> allArtists,  String searchQuery,  ArtistSortType sortType)  $default,) {final _that = this;
switch (_that) {
case _ArtistsState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<ArtistInfo> allArtists,  String searchQuery,  ArtistSortType sortType)?  $default,) {final _that = this;
switch (_that) {
case _ArtistsState() when $default != null:
return $default(_that.allArtists,_that.searchQuery,_that.sortType);case _:
  return null;
...
class _ArtistsState implements ArtistsState {
  const _ArtistsState({required final  List<ArtistInfo> allArtists, required this.searchQuery, required this.sortType}): _allArtists = allArtists;
  

 final  List<ArtistInfo> _allArtists;
@override List<ArtistInfo> get allArtists {
